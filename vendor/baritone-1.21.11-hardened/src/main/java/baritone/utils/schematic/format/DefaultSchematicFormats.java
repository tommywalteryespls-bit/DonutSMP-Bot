...
public enum DefaultSchematicFormats implements ISchematicFormat {
    ...
    MCEDIT("schematic") {
        ...
        public IStaticSchematic parse(InputStream input) throws IOException {
            return new MCEditSchematic(NbtIo.readCompressed(input, nbtQuota()));
        }
    },
    ...
    SPONGE("schem") {
        @Override
        public IStaticSchematic parse(InputStream input) throws IOException {
            CompoundTag nbt = NbtIo.readCompressed(input, nbtQuota());
    ...
    private static NbtAccounter nbtQuota() {
        return NbtAccounter.create(MAX_NBT_BYTES);
    }
